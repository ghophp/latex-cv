...
\begin{outerlist}
    ...
    \item[] \textit{Senior Backend Engineer}%
            \hfill \textbf{March 2018 to present}\\
            InnoGames allows me to see the software industry from a 500 plus employees point of view. Here I have been challenged to work in a cross-functional team handling the implementation of features and technical stability for the Elvenar game. The stack is PHP based with CI/CD using Jenkins and Puppet, in-house servers, and more than 30 million active users.
