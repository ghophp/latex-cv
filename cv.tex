...
network, rest, database normalisation, \href{https://guides.github.com/introduction/flow/}{github flow}, micro-services \& monolith architectures, continuous integration \& deployment, refactoring strategies, system design, agile \& kanban methodologies, message systems, protocols

\section{Frameworks \& Tools}

\textbf{strong} git, bash, Kubernetes, Docker, AWS EC2, RDS, ECS, SNS, SQS, SES, S3, RabbitMQ, Redis, Postgres, Jenkins, Travis, Angular, NPM, Android, Zend, Symphony \& Doctrine
%
