...
\begin{outerlist}
    ...
    \item[] \textit{Senior Backend Engineer}%
            ...
            Joined Zalando to contribute to the ambitious plans of the company regarding becoming a platform for fashion. Working in a cross-functional team responsible for IAM solutions and gateways that power the entire ecosystem. Fully microservices oriented, I am able to write code for multiple porpuses, with different architectures and languages.
...
\begin{outerlist}
    ...
    \item[] \textit{Senior Backend Engineer}%
            ...
            InnoGames allowed me to have a nice share of experience in the game industry. The constant load and peaks of millions of concurrent users pushed the infrastructure to the limits. Working with a cross-functional team to deliver features and maintain Elvenar, in a bit more than a year we had great results achieved, especially modernizing the stack that powers the game.
...
\textbf{strong} Golang, PHP, Distributed Systems, SQL, JavaScript, HTML5 \& CSS
%

\halfblankline

\textbf{moderate} Network, Java \& Scala \& JVM, Python, C++, ActionScript 3 \& Regular Expressions
%

\halfblankline

\textbf{have used} C\# \& Unity, Objective-C, bash/shell scripting, C\#, AutoLISP \& LaTeX
%

\section{Concepts \break Knowledge}

rest, database normalisation, \href{https://guides.github.com/introduction/flow/}{github flow}, micro-services \& monolith architectures, continuous integration \& deployment, refactoring strategies, system design, agile \& kanban methodologies, message systems, protocols
...
Portuguese (mother tongue), English (fluent with slangs), Spanish (moderate) \& German (beginner).
