...
\begin{innerlist}
	\item Rapid understanding of new technologies and concepts.
...
\begin{innerlist}
    \item Maintaining and evolving the Identity and Access Management solution of Zalando, more specifically in the Merchant Operations department, powering the access of partners, internal employees and service-to-service clients.
    \item Contributed to the further improvement of a highly profitable game in a major studio with 500 plus employees.
...
\begin{outerlist}
    ...
    \item[] \textit{Senior Backend Engineer}%
            \hfill \textbf{April 2019 to present}\\
...
\begin{outerlist}
    ...
    \item[] \textit{Senior Software Engineer}%
			...
			Creating backend, web, and mobile apps for high quality outsourced development as ThoughtWorks. Developed a social network called SocialBase. Working with Java, PHP, Angular, AWS.
...
\begin{outerlist}
    ...
    \item[] \textit{UNISOCIESC}%
            ...
            In college, I was one of the top students, even working the entire day during the whole four years of study. I won the prize Best Final Paper of University 2013, which later helped me to be accepted at the masters.
...
OAuth2, IAM, network, rest, database normalisation, \href{https://guides.github.com/introduction/flow/}{github flow}, micro-services \& monolith architectures, continuous integration \& deployment, refactoring strategies, system design, agile \& kanban methodologies, message systems, protocols

\section{Frameworks \& Tools}

\textbf{strong} git, bash, Kubernetes, Docker, AWS EC2, RDS, ECS, SNS, SQS, SES, S3, RabbitMQ, Redis, Postgres, Jenkins, Travis, Angular, NPM, Android, Zend, Symphony \& Doctrine, Keycloak
%

\halfblankline

\textbf{moderate} EKS, React, BuildBot, MongoDB, Play Framework, NodeJS, Python Twisted \& Cyclone, Socket.io, DNS, Unix, Firewall \& Qt
%

\halfblankline

\textbf{have used} Nomad, Consul, Vault, Hibernate, Akka, BackboneJS, Realm.io, XCode \& Elastic Beanstalk, Unity
%
...
%
Guilherme is a talented language-agnostic programmer. No matter which language, he always begins with the problem itself, a rare characteristic nowadays. Also, he has a great team spirit, making him easy to fit in any high skilled team.
